...
const whereAmI = async function (country) {
  try {
    ...
    const res = await fetch(
      `https://restcountries.eu/rest/v2/name/${dataGeo.countryyyyyy}`
    );
    ...
    //Reject promis returned from async functionn
    throw err;
  }
};
...
(async function () {
  ...
  console.log(`3: Finiched getting locatio`);
})();
*/
/*
...
get3Countries('Canada', 'India', 'USA');
*/
/*
//Promis.race
(async function () {
